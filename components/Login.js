...
const Login = () => {
    return (
        <div id='login-container' className='fixed transition-all rounded-b-[30px] duration-200 -translate-y-[40vh] xl:-translate-y-[13vh] top-0 left-0 h-[37vh] xl:h-[12vh] w-screen bg-gray-50'>
