...
const Bisection = () => {
    return (
        <div className="w-full h-[25rem]] bg-gray-100 border-4 border-[#2e2e2d] border-dashed lg:w-[40%] lg:h-full rounded-[20px] flex flex-col gap-6 justify-center items-center p-4">
            ...
            <Link href="/solve/method/bisection-method" className="w-auto bg-[#2e2d2d] text-[#04aa6d] text-sm font-bold rounded-full h-12 py-2 px-4 flex items-center gap-2 justify-between">
                Calculate
